...
export async function renderChannelsV2Image(data, saveId) {
  return renderImage(data, saveId, "channels-v2")
}

export async function renderSlaAlertImage(data, saveId) {
  return renderImage(data, saveId, "sla-alert")
}
